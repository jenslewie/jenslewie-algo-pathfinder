...
class LeetCode0082Test {
    ...
    private static final LeetCode0082_2 SOLUTION_2 = new LeetCode0082_2();
    ...
    private static final Map<String, DeleteDuplicatesFunction> ALGO_VARIANTS = Map.of(
            "two_pointers_dual_list", SOLUTION_1::deleteDuplicates,
            "single_pass_sentinel", SOLUTION_2::deleteDuplicates
    );
